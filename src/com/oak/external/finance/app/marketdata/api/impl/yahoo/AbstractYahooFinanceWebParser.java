...
public abstract class AbstractYahooFinanceWebParser<T> {
	...
	dates.clear();
		...
		Element dateRootElt = datesRefElts.get(0).parent().parent()
			.parent();
    ...
    private void exctractDoubleValues(String key, String value,
    ...
    private SortedMap<Date, T> createStatementsFromDoubeMap( String symbol,
