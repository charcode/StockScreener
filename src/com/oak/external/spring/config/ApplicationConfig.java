...
import com.oak.external.utils.input.api.impl.ResourceFileStreamProvider;
...
public class ApplicationConfig {
	...
	BalanceSheetDao yahooWebDataBalanceSheet = new YahooWebDataBalanceSheetDao(
		LogManager.getFormatterLogger(YahooWebDataBalanceSheetDao.class));
	...
	Logger logger = LogManager
		.getFormatterLogger(FinanceFundamentalAnalysisControllerImpl.class);
