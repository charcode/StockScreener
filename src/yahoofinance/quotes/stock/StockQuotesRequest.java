...
public class StockQuotesRequest extends QuotesRequest<StockQuotesData> {
    ...
    public StockQuotesRequest(String query, Logger logger) {
        super(query, StockQuotesRequest.DEFAULT_PROPERTIES, logger);
    }
    ...
    protected StockQuotesData parseCSVLine(String line) {
        ...
        return new StockQuotesData(parsedLine.toArray(new String[this.properties.size()]), logger);
    }
