...
public class YahooFinance {
    ...
    public YahooFinance (Logger logger){
    	this.logger = logger;
    ...
    */
    ...
    public  FxQuote getFx(String symbol) throws IOException {
        FxQuotesRequest request = new FxQuotesRequest(symbol, logger);
    ...
    public  Map<String, FxQuote> getFx(String[] symbols) throws IOException {
        FxQuotesRequest request = new FxQuotesRequest(utils.join(symbols, ","), logger);
    ...
    private  Map<String, Stock> getQuotes(String query, boolean includeHistorical) throws IOException {
        StockQuotesRequest request = new StockQuotesRequest(query, logger);
    ...
    private  Map<String, Stock> getQuotes(String query, Calendar from, Calendar to, Interval interval) throws IOException {
        Map<String, Stock> stocks = getQuotes(query, false);
        stocks = fetchHistoricalQuotes(stocks, from, to, interval);
        return stocks;
    }
    
    private  Map<String, Stock> fetchHistoricalQuotes(Map<String, Stock> stocks, Calendar from, Calendar to, Interval interval) throws IOException {
